        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl space-y-6 p-6 font-sans">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="font-display text-3xl font-bold text-slate-900 dark:text-white">Tambah Customer</h1>
                        <p className="mt-1 text-sm text-slate-500">Daftarkan akun customer baru ke dalam sistem.</p>
                    </div>
                    <Button
                        variant="outline"
