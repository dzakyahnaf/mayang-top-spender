...
const inputClass =
    'focus-visible:ring-mayang-500/20 focus-visible:border-mayang-500 bg-white/60 dark:bg-zinc-950/40 border-slate-200 dark:border-zinc-800/80 py-5.5 focus-visible:ring-4 transition-all duration-300';

export default function HadiahCreate() {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Hadiah', href: '/admin/hadiah' },
        { title: 'Tambah', href: '/admin/hadiah/create' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl space-y-6 p-6 font-sans">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="font-display text-3xl font-bold text-slate-900 dark:text-white">Tambah Hadiah</h1>
                        <p className="mt-1 text-sm text-slate-500">Tetapkan hadiah untuk rentang peringkat tertentu.</p>
                    </div>
                    <Button
                        variant="outline"
                    ...
                    <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Contoh: Voucher Belanja Rp 2.000.000"
                                className={inputClass}
                            />
