            ...
            <div className="p-6 max-w-4xl space-y-6 font-sans">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Ubah informasi akun kasir pilihan.</p>
                    </div>
                ...
                <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white/50 p-6 shadow-xl dark:border-slate-800/50 dark:bg-slate-900/40 backdrop-blur-md">
                    <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="password" className="text-sm font-semibold text-slate-700 dark:text-slate-300">Password Baru</Label>
                            <Input
                                id="password"
                                type="password"
                                value={data.password}
