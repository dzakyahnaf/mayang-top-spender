            ...
            <div className="p-6 max-w-4xl space-y-6 font-sans">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Ubah nominal belanja atau catatan transaksi customer.</p>
                    </div>
                ...
                <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white/50 p-6 shadow-xl dark:border-slate-800/50 dark:bg-slate-900/40 backdrop-blur-md">
                    <form onSubmit={submit} className="max-w-2xl space-y-6">
                        <div className="flex items-center gap-2 pb-4 border-b border-slate-100 dark:border-slate-855">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-mayang-50/10 text-mayang-600">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="notes" className="text-sm font-semibold text-slate-700 dark:text-slate-300">Catatan</Label>
                            <textarea
                                id="notes"
                                value={data.notes}
                                onChange={(e) => setData('notes', e.target.value)}
                                rows={3}
                                className="flex min-h-[80px] w-full rounded-xl border border-slate-200 bg-white/50 dark:bg-slate-955/20 px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mayang-500/30 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                            />
                        </div>
