                    ...
                    <form onSubmit={submit} className="max-w-2xl space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="focus-visible:ring-mayang-500/20 focus-visible:border-mayang-500 dark:placeholder:text-zinc-550 flex min-h-[85px] w-full rounded-xl border border-slate-200 bg-white/60 px-3 py-2.5 text-sm transition-all duration-300 placeholder:text-slate-400 focus-visible:ring-4 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800/80 dark:bg-zinc-950/40"
                            />
                        </div>
