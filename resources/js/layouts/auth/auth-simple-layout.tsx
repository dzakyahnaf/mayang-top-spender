...
export default function AuthSimpleLayout({ children, title, description }: AuthLayoutProps) {
    return (
        <div className="selection:bg-mayang-500 from-mayang-50 to-mayang-100/70 relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br via-white p-6 font-sans text-slate-900 selection:text-white md:p-10">
            {/* Spotlight Glow */}
                ...
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col items-center gap-4 text-center">
                        <Link href="/" className="group flex flex-col items-center gap-3 transition hover:opacity-80">
                            ...
                            <span className="text-xl font-bold tracking-tight text-slate-900">Mayang</span>
