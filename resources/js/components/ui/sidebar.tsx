...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'>>(({ className, children, ...props }, ref) => {
    return (
        <main
            ref={ref}
            className={cn(
                'relative flex min-h-svh w-full min-w-0 flex-1 flex-col bg-gradient-to-br from-mayang-50 via-white to-mayang-100/60 dark:from-zinc-950 dark:via-zinc-900/60 dark:to-mayang-950/20',
